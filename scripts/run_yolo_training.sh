...
#SBATCH --output=logs/yolo-train-output.log
#SBATCH --error=logs/yolo-train-error.log
#SBATCH --gres=gpu:1
#SBATCH --mem=64G
#
# Full pipeline: COCO split → yolo_dataset/ → train Ultralytics YOLO (see train_yolo_model.py).
#
